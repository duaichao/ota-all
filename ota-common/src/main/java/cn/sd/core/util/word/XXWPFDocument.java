 ...
 *   
 */    
public class XXWPFDocument extends XWPFDocument {    
    public XXWPFDocument(InputStream in) throws IOException {    
        super(in);    
    }    
     ...
     * @throws IOException  
     */    
    public XXWPFDocument(OPCPackage pkg) throws IOException {    
        super(pkg);    
        // TODO Auto-generated constructor stub     
