		...
		<script type="text/javascript">
			...
			Ext.onReady(function(){
				var win = Ext.create('Ext.window.Window',{
					title:'<span style="font-size:16px;color:#fff"><i class="iconfont" style="position:relative;top:0px;font-size:15px;">&#xe6b6;</i> 支付失败</span>',
					width:360,
					height:180,
					bodyPadding:30,
					modal:true,
					...
					maximizable:false,
					html:[
						'<i class="iconfont red-color" style="font-size:30px;position:relative;top:5px;">&#xe6b6;</i> ',
						'<span class="f18">您的订单支付失败！</span>',
