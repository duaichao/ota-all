		...
		<script type="text/javascript">
			...
			Ext.onReady(function(){
				var win = Ext.create('Ext.window.Window',{
					title:'<span style="font-size:16px;color:#fff"><i class="iconfont" style="position:relative;top:0px;font-size:15px;">&#xe6ae;</i> 座位不足</span>',
					width:360,
					height:180,
					bodyPadding:30,
					modal:true,
					...
					html:[
						...
						'<span class="f18">座位不足，请联系卖家！</span>',
