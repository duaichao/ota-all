...
import cn.sd.core.pay.cft.config.TenpayConfig;
import cn.sd.core.pay.cft.handler.RequestHandler;
import cn.sd.core.pay.cft.util.TenpayUtil;
...
public class PayService extends BaseDaoImpl implements IPayService{
	 ...
	 */
	public Map<String, Object> alipay(String orderNo,String bankCode,Double money,boolean isBankPay,String uid, String type, String isEarnest){
		...
		sParaTemp.put("isEarnest", isEarnest);
	...
	public Map<String, Object> cftpay(String orderNo,String bankCode,Double money,boolean isBankPay,String uid, HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			result.put("sParaTemp", requestUrl);
