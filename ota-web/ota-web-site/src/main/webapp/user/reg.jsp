...
<body>
	...
	<div class="contain-reg">
		...
		<div class="reg-top">
			<a href="${ctx}/user/to/login" target="_self" class="reg-topbtn">登录</a>
		</div>
		<div class="reg-form">
			<div class="reg-formtit">注册账号</div>
			<div class="reg-formcon">
				<form action="${ctx}/user/reg" method="post" id="regFrom" class="form-horizontal">
					...
					<div class="form-group">
					    <label class="col-md-4 control-label" for="formGroupInput">用户名：</label>
					    <div class="col-md-4">
					      	<input class="form-control" type="text" name="pm[USER_NAME]" id="user_name" placeholder="请输入用户名">
					    </div>
				  	</div>
				  	<div class="form-group">
					    <label class="col-md-4 control-label" for="formGroupInput">手机号码：</label>
					    <div class="col-md-4">
					      	<input class="form-control" type="text" name="pm[MOBILE]" id="mobile" placeholder="请输入手机号码">
					    </div>
				  	</div>
				  	<div class="form-group">
					    <label class="col-md-4 control-label" for="formGroupInput">校验码：</label>
					    <div class="col-md-2">
					      	<input class="form-control" type="text" name="pm[CODE]" id="code" maxlength="6" placeholder="请输入校验码">
					    </div>
					    <div class="col-md-2">
				  	...
				  	<div class="form-group">
					    ...
					    <div class="input-group col-md-4" style="padding-left:15px; padding-right:15px;">
					      	<input class="form-control" type="password" maxlength="20" name="pm[PASSWORD]" id="password" placeholder="6-20位字母、数字和符号">
				  	...
				  	<div class="form-group">
					    <label class="col-md-4 control-label" for="formGroupInput"></label>
					    <div class="col-md-4">
					    	<button class="btn btn-sign btn-block" type="submit" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">下一步</button>
					    </div>
					</div>
				</form>
			</div>
