Ext.define('Weidian.view.ux.dataview.ListSwipeAction', {
    ...
    createButtons: function(view, index, listItem, rec, e) {
        ...
        if(!element.down('.x-list-action-wrap')) {
            ...
            Ext.each(buttons,function(btn){
                ...
                button.setHandler(Ext.Function.createInterceptor(Ext.pass(button.getHandler(),[rec,me.getList()]),function(){
    ...
    toggleButtons: function(swipeEvent) {
        var targetEl = Ext.get(swipeEvent.target),
            listItemEl = (targetEl.up('.x-listitem') || targetEl),
    ...
    createButton: function(element, record, btnCfg, right) {
        ...
        return Ext.create('Ext.Button',Ext.Object.merge({
            ...
            style: 'border-radius:0px;position:absolute;right:'+right+';border-width:0px;',
            renderTo: element,
            listeners: {
