...
public class RouteEntity {
	...
	private List<Map<String, String>> startCity;
	
	private List<Map<String, Object>> calendar;
	private List<Map<String, Object>> album;
	...
	public void setCalendar(List<Map<String, Object>> calendar) {
		this.calendar = calendar;
	}
	public List<Map<String, Object>> getAlbum() {
		return album;
	}
	public void setAlbum(List<Map<String, Object>> album) {
		this.album = album;
	}
	public List<Map<String, String>> getStartCity() {
		return startCity;
	}
	public void setStartCity(List<Map<String, String>> startCity) {
