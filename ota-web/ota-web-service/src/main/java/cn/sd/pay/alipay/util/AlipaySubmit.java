...
import cn.sd.core.pay.alipay.config.AlipayConfig;
import cn.sd.core.pay.alipay.sign.MD5;
import cn.sd.core.pay.alipay.util.httpClient.HttpProtocolHandler;
import cn.sd.core.pay.alipay.util.httpClient.HttpRequest;
import cn.sd.core.pay.alipay.util.httpClient.HttpResponse;
import cn.sd.core.pay.alipay.util.httpClient.HttpResultType;
...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
        ...
        String mysign = "";
        String AliPayKey = sPara.get("AliPayKey");
        if(AlipayConfig.sign_type.equals("MD5") ) {
        	if(CommonUtils.checkString(AliPayKey)){
